...
namespace Lab_2
{
    ...
    {
        const string sql_address = "Data Source=(LocalDB)\\MSSQLLocalDB;AttachDbFilename=D:\\Git\\Labs\\Labs_3_course\\6-sem\\DataBase\\Lab_2\\Lab_2\\MyDatabase.mdf;Integrated Security=True";
        public MainForm()
        {
            InitializeComponent();
            DatabaseController.InitConnection(sql_address);
            FormsController.instance.MainForm = this;
            
            //DatabaseController.DisplayTable("Books");
        }
